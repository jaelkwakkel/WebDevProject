...
public class EnableAuthenticatorModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        await _emailSender.SendEmailAsync(user.Email, "Enabled 2fa",
            "Two factor authentication has been enabled on your account! Not you? Please contact support.");
    ...
    private async Task LoadSharedKeyAndQrCodeUriAsync(SetupUser user)
    {
